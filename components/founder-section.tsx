...
export default function FounderSection({ about }: { about: any }) {
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-16 lg:mb-20">
            ...
            <motion.div  className="space-y-8">
              {/* Name and Title */}
              <div>
                <h3 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-2"> {about.founderName}</h3>
