...
const iconMap: { [key: string]: React.ElementType }={ Star, Quote, ChevronLeft, ChevronRight, Facebook, Twitter, Linkedin}
...
export default function MobileTestimonialsSection({ about }: { about: any }) {
    ...
    >
      ...
      <div className="max-w-sm mx-auto px-4 relative">
        ...
        <div className={`relative ${isVisible ? "animate-fade-in-delay" : "opacity-0"}`}>
          ...
          >
            {about.testimonialsSectionCollection.items.map((testimonial:any) => {
          ...
          <div className="flex justify-center mt-6 space-x-2">
            {about.testimonialsSectionCollection.items.map((_:any, index:number) => (
              <button
                key={index}
